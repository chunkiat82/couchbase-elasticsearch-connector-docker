...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CBES_CHECKPOINT_CLEAR_OPTS%  -classpath "%CLASSPATH%" com.couchbase.connector.elasticsearch.cli.CheckpointClear %CMD_LINE_ARGS%
...
if  not "" == "%CBES_CHECKPOINT_CLEAR_EXIT_CONSOLE%" exit 1
exit /b 1
