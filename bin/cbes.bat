...
@rem ##########################################################################
@rem
@rem  cbes startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CBES_OPTS to pass JVM options to this script.
set DEFAULT_JVM_OPTS="-server"
...
@rem Execute cbes
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CBES_OPTS%  -classpath "%CLASSPATH%" com.couchbase.connector.elasticsearch.ElasticsearchConnector %CMD_LINE_ARGS%
...
:fail
rem Set variable CBES_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CBES_EXIT_CONSOLE%" exit 1
exit /b 1
