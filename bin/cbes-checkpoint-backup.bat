...
@rem ##########################################################################
@rem
@rem  cbes-checkpoint-backup startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CBES_CHECKPOINT_BACKUP_OPTS to pass JVM options to this script.
...
@rem Execute cbes-checkpoint-backup
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CBES_CHECKPOINT_BACKUP_OPTS%  -classpath "%CLASSPATH%" com.couchbase.connector.elasticsearch.cli.CheckpointBackup %CMD_LINE_ARGS%
...
:fail
rem Set variable CBES_CHECKPOINT_BACKUP_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CBES_CHECKPOINT_BACKUP_EXIT_CONSOLE%" exit 1
exit /b 1
